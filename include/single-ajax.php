        ...
        if ( isset($_REQUEST) ) {
            ...
            <div class="col-md-6 lp-insert-data">
                <div class="lp-grid-box-thumb">
                    <div class="slide">
                        <img src="<?php echo $data_return['post_thumb']; ?>" alt="<?php echo $data_return['ptitle']; ?>">
                    </div>
                </div>
                <div class="lp-grid-desc-container lp-border clearfix">
                    <div class="lp-grid-box-description ">
                        <div class="lp-grid-box-left pull-left">
                            <h4 class="lp-h4">
                                <a href="<?php echo $data_return['permalink']; ?>">
                                    <?php if( $data_return['adStatus'] == 'active'){ echo $CHeckAd; }  ?> <?php echo $data_return['ptitle']; ?> <?php echo $claim; ?>
                                </a>
                            </h4>
                            <ul>
                                <li>
                                    ...
                                    if( $data_return['rate'] == '' )
                                    {
                                        echo $data_return['noreview'];
                                    }
                                    else
                                    {
                                        echo '<span class="rate">'. $data_return['rate'] .'<sup>/5</sup></span>';
                                    }
                                    ?>
                                </li>
                                <li class="middle"><?php echo  $data_return['pricey']; ?></li>
                                <li><?php echo $data_return['cats_markup']; ?></li>
                                <li><a href="tel:<?php echo $data_return['phone']; ?>"><?php echo $data_return['phone']; ?></a></li>
                            </ul>
                            <div class="lp-grid-desc">
                                <p><?php echo $data_return['post_content']; ?></p>
                            </div>
                        </div>
                    ...
                    <div class="lp-grid-box-bottom">
                        <div class="pull-left">
                            <?php echo $data_return['adress_markup']; ?>
                        </div>
                        <div class="pull-right">
                            <a href="#" class="status-btn"><?php echo $data_return['openStatus']; ?></a>
                        </div>
