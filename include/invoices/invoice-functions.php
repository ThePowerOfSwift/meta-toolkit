...
if(!function_exists('get_campaign_wire_invoice')){
	function get_campaign_wire_invoice($postid){
		...
		$payment_method = '';
		$plansData = '';
		$campaigns = listing_get_metabox_by_ID('listings_ads_purchase_packages', $postid);
		if( !empty($campaigns) ){
			$campaigns = array_unique($campaigns);
			foreach( $campaigns as $package=>$pkgprice ){
				
				$org_plan_price = $org_plan_price + $pkgprice;
			...
			<div class="invoice-area">
				...
				<div class="row heading-area">
					...
					<div class="col-md-2 col-sm-2 col-xs-12">
						<p><strong>'.esc_html__('Campaigns On','listingpro').'</strong></p>
					</div>
					<div class="col-md-2 col-sm-2 col-xs-12">
				...
				<div class="row invoices-company-details">
					<div class="col-md-6 col-sm-6 col-xs-12">
						...
						<p><br />'.$listingpro_options["direct_payment_instruction"].'</p>
					</div>
					<div class="col-md-2 col-sm-2 col-xs-12">
						<p>'.$plansData.'</p>
					</div>
